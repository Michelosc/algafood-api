...
import static com.algaworks.algafoodapi.api.v1.controller.EstatisticasController.EstatisticasModel;
...
public interface EstatisticasControllerOpenApi {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "dataCriacaoInicio", value = "Data/hora incial da criação do pedido", example = "2019-12-01T00:00:00Z", dataType = "date-time"),
